angular.module('PicketLinkSecurityModule', ['ngResource', 'ngRoute']).config(
    ...
    .factory('MeResource', ['$resource', function($resource) {
        return $resource('rest/private/account/me', {}, {
            activation: {method: 'GET', params: {}}
        });
    }])
...
function LoginCtrl($scope, LoginResource, SecurityService, $location, $rootScope, MeResource) {
    $scope.newUser = {};
